 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".gallery-cases__slider")) new swiper_core_Swiper(".gallery-cases__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 2,
                ...
                speed: 800,
                pagination: {
                    el: ".slider-gallery-cases__pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".slider-gallery-cases-button-prev",
                    nextEl: ".slider-gallery-cases-button-next"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
...
***************************************************************************** */
        ...
        window.onload = function() {
            ...
            if (inputTel) window.intlTelInput(inputTel, {
                initialCountry: "auto",
            ...
            if (inputTelPopup) window.intlTelInput(inputTelPopup, {
                initialCountry: "auto",
                autoInsertDialCode: "true",
                geoIpLookup: callback => {
                    fetch("https://ipapi.co/json").then((res => res.json())).then((data => callback(data.country_code))).catch((() => callback("us")));
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            const image1 = document.querySelector(".integration-saas__image_1");
            const image2 = document.querySelector(".integration-saas__image_2");
            const menuServicesItems = document.querySelectorAll(".menu-services__link");
            const menuServicesItem1 = document.querySelector(".menu-services__link_1");
            const menuServicesItem2 = document.querySelector(".menu-services__link_2");
            const menuServicesItem3 = document.querySelector(".menu-services__link_3");
            const menuServicesItem4 = document.querySelector(".menu-services__link_4");
            const menuServicesItem5 = document.querySelector(".menu-services__link_5");
            document.addEventListener("watcherCallback", (function(e) {
                const entry = e.detail.entry;
                const targetElement = entry.target;
                if (targetElement.classList.contains("integration-saas__item_1")) {
                    if (image2.classList.contains("active")) image2.classList.remove("active");
                    image1.classList.add("active");
                } else if (targetElement.classList.contains("integration-saas__item_2")) {
                    if (image1.classList.contains("active")) image1.classList.remove("active");
                    image2.classList.add("active");
                } else if (targetElement.classList.contains("item-activity-services_1")) {
                    menuServicesItems.forEach((element => {
                        element.classList.remove("active");
                    }));
                    menuServicesItem1.classList.add("active");
                } else if (targetElement.classList.contains("item-activity-services_2")) {
                    menuServicesItems.forEach((element => {
                        element.classList.remove("active");
                    }));
                    menuServicesItem2.classList.add("active");
                } else if (targetElement.classList.contains("item-activity-services_3")) {
                    menuServicesItems.forEach((element => {
                        element.classList.remove("active");
                    }));
                    menuServicesItem3.classList.add("active");
                } else if (targetElement.classList.contains("item-activity-services_4")) {
                    menuServicesItems.forEach((element => {
                        element.classList.remove("active");
                    }));
                    menuServicesItem4.classList.add("active");
                } else if (targetElement.classList.contains("item-activity-services_5")) {
                    menuServicesItems.forEach((element => {
                        element.classList.remove("active");
                    }));
                    menuServicesItem5.classList.add("active");
                }
            }));
        }));
        window["FLS"] = true;
